...
val_pipeline = [
    ...
    dict(
        type='Custom3DPack',
        keys=['img','occ_semantickitti_masked','points'],
        meta_keys=['lidar2img','sample_id','frame_id'])
]
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        #ann_file='/media/spalab/sdb/dhkim/OCCFusion/data_infos/occfusion_train_baseline.pkl',
        ann_file = '/media/spalab/sdb/dhkim/OCCFusion/data_infos/occfusion_train_non_post.pkl',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(img_path='',pts_semantic_mask_path='',lidar=''),
        ann_file='/media/spalab/sdb/dhkim/OCCFusion/data_infos/occfusion_val_final_400_900.pkl',
...
train_cfg = dict(type='EpochBasedTrainLoop', max_epochs=24,val_begin=1, val_interval=2)
