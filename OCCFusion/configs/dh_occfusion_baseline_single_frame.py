...
#point_cloud_range = [0,-25.6, -2.0, 38.4, 25.6,  6.0]
#point_cloud_range = [-38.4,-19.2,-2.0, 0, 19.2,  6.0]
point_cloud_range = [-25.6, -12.8, -2.0, 0, 12.8, 4.4]
grid_size_vt = [128, 128, 32] 
...
model = dict(
    ...
    view_transformer=dict(
        ...
        grid_size=[[128, 128, 32],    
                  [64, 64, 16],     
                  [32, 32, 8]],
        # grid_size = [[152, 240, 40], [76, 120, 20], [38, 60, 10]], 
        x_bound=[-25.6, 0],
        y_bound=[-12.8, 12.8],
        z_bound=[-2., 4.4],
        sampling_rate=[4,5,6],
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='/media/spalab/sdb/dhkim/OCCFusion/data_infos/occfusion_infos_train_debug.pkl',
