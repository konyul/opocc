...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='/mnt/sdb/kypark/OCCFusion/data_infos/occfusion_train_.0803.pkl',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(img_path='',pts_semantic_mask_path='',lidar=''),
        ann_file='/mnt/sdb/kypark/OCCFusion/data_infos/occfusion_val_final_0_2000.pkl',
