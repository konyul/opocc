...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='/media/spalab/sdb/dhkim/OCCFusion/data_infos/occfusion_train_add_geom_1_5.pkl',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(img_path='',pts_semantic_mask_path='',lidar=''),
        ann_file='/media/spalab/sdb/dhkim/OCCFusion/data_infos/occfusion_pseudo_val_final_0_2000_1_5.pkl',
