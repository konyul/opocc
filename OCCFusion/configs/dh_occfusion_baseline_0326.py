...
model = dict(
    ...
    use_lidar=use_lidar,
    use_radar=use_radar,
    npy_save_folder='./400_900_baseline_sota',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='/media/spalab/sdb/dhkim/OCCFusion/data_infos/occfusion_train_0802.pkl',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(img_path='',pts_semantic_mask_path='',lidar=''),
        ann_file='/mnt/sdb/kypark/OCCFusion/data_infos/occfusion_val_final_400_900.pkl',
